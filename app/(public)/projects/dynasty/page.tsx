  ...
  return (
    <div className={styles.container}>
      <ProjectInfo
        name={"Dynasty"}
        subtitle={""}
        imgUrl={"/imgs/projects/dynasty/0.png"}
        width={970}
        height={971}
      >
        <p>
          Dynasty - магазин, который имеет широкий ассортимент товаров от
          ведущих мировых брендов, включая ракетки, мячи, кроссовки, одежду и
          аксессуары.
        </p>
        <br />
        ...
        <Image
          ...
          src={"/imgs/projects/dynasty/man.png"}
          alt={"man"}
          width={711}
          height={711}
          sizes="100vw"
      ...
      <div className={styles.gallery}>
        <div className={styles.gallery__row}>
          ...
          <ImageWithSubtitle
            imgUrl="/imgs/projects/dynasty/1.png"
            subtitle=""
            width={1494}
            height={713}
          />
